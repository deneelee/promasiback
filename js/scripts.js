...
(function($) {
    ...
    function lsubmitForm() {
        ...
        //var obser = $("#lobser").val();/* ------------------- */
        
        $.ajax({
            type: "POST",
            url: "php/callmeform-process.php",
            data: "name=" + name + "&phone=" + phone + "&email=" + email + "&select=" + select + "&terms=" + terms,// + "&obser=" + obser,  /* ------------------- */
    ...
    function csubmitForm() {
        ...
        //var obser = $("#cobser").val(); /* ------------------- */
        
        $.ajax({
            type: "POST",
            url: "php/contactform-process.php",
            data: "name=" + name + "&email=" + email + "&message=" + message + "&terms=" + terms,// + "&obser=" + obser, /* ------------------- */
            success: function(text) {
                if (text == "success") {
                    cformSuccess();
                } else {
    ...
    function psubmitForm() {
        ...
        //var obser = $("#pobser").val(); /* ------------------- */
        
        $.ajax({
            type: "POST",
            url: "php/privacyform-process.php",
            data: "name=" + name + "&email=" + email + "&select=" + select + "&terms=" + terms,// + "&obser=" + obser, /* ------------------- */
            success: function(text) {
                if (text == "success") {
                    pformSuccess();
                } else {
