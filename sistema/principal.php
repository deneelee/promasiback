...
<body class="sb-nav-fixed">
  <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
    ...
    <button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#">
      <i style="color: #14bf98;" class="fas fa-bars"></i></button>
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid">
          <h1><br></h1>
          <ol class="breadcrumb mb-4" style="text-align: center !important;">
            <li class="breadcrumb-item active" ><b >Registro</b> </li>
          </ol>
          ...
          <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-4">
                <label for="">NSS:</label>
                <input required="required" title="Por favor ingrese número de seguro social con 11 digitos, en caso de contener cero al principio agregar ' ." type="text" name="txtNSS" class="form-control" minlength="11" maxlength="11" <?php echo (isset($error['NSS'])) ? "is-invalid" : ""; ?> value="<?php echo $txtNSS; ?>" placeholder="Ejemplo:  '04122222227" id="txtNSS">
              ...
              <div class="form-group col-md-4">
                ...
                <input title="Aquí debe colocar la ocupación." required="required" type="text" name="txtOcupacion" class="form-control" <?php echo (isset($error['Ocupacion'])) ? "is-invalid" : ""; ?> value="<?php echo $txtOcupacion; ?>" placeholder="Ejemplo:  AYUDANTE GENERAL" id="txtOcupacion">
                <div class="invalid-feedback">
              ...
              <div class="form-group col-md-4">
                ...
                <input title="Aquí debe de colocar el o los nombre (s)." required="required" type="text" name="txtNombre" class="form-control" <?php echo (isset($error['Nombre'])) ? "is-invalid" : ""; ?> value="<?php echo $txtNombre; ?>" id="txtNombre">
                <div class="invalid-feedback">
              ...
              <div class="form-group col-md-4">
                ...
                <input title="Aquí debe de colocar el apellido paterno." required="required" type="text" name="txtApellidoP" class="form-control" <?php echo (isset($error['ApellidoP'])) ? "is-invalid" : ""; ?> value="<?php echo $txtApellidoP; ?>" id="txtApellidoP">
              ...
              <div class="form-group col-md-4">
                ...
                <input title="Aquí debe de colocar el apellido materno." required="required" type="text" name="txtApellidoM" class="form-control" <?php echo (isset($error['ApellidoM'])) ? "is-invalid" : ""; ?> value="<?php echo $txtApellidoM; ?>" id="txtApellidoM">
              ...
              <div class="form-group col-md-3">
                ...
                <input title="Aquí debe de colocar la dirección." required="required" type="text" name="txtCalle" class="form-control" <?php echo (isset($error['Calle'])) ? "is-invalid" : ""; ?> value="<?php echo $txtCalle; ?>" id="txtCalle">
              ...
              <div class="form-group col-md-1">
                ...
                <input title="Colocar número de vivienda." required="required" type="text" name="txtNumero" class="form-control" <?php echo (isset($error['Numero'])) ? "is-invalid" : ""; ?> value="<?php echo $txtNumero; ?>" placeholder="" id="txtNumero">
                <div class="invalid-feedback"><?php echo (isset($error['Numero'])) ? $error['Numero'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-2">
                <label for=""><a href="https://www.correosdemexico.gob.mx/SSLServicios/ConsultaCP/Descarga.aspx" target="_blank" style="color: black;">C.P.:</a></label>
                <input title="Colocar código postal, favor de verificar en  SEPOMEX. De click en C.P.: para ir a la página" required="required" type="text" name="txtCP" class="form-control" <?php echo (isset($error['CP'])) ? "is-invalid" : ""; ?> value="<?php echo $txtCP; ?>" placeholder="" id="txtCP">
                <div class="invalid-feedback"><?php echo (isset($error['CP'])) ? $error['CP'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-2">
                <label for=""><a href="https://www.correosdemexico.gob.mx/SSLServicios/ConsultaCP/Descarga.aspx" target="_blank" style="color: black;">Colonia:</a></label>
                <input title="Colocar la Colonia si la desconoce puede dar click en Colonia: para consultarla en la página SEPOMEX." required="required" type="text" name="txtColonia" class="form-control" <?php echo (isset($error['Colonia'])) ? "is-invalid" : ""; ?> value="<?php echo $txtColonia; ?>" placeholder="" id="txtColonia">
              ...
              <div class="form-group col-md-2">
                ...
                <input title="Colocar la ciudad a la que pertenece su colonia, si la desconoce puede dar click en Ciuada: para consultarla." required="required" type="text" name="txtCiudad" class="form-control" <?php echo (isset($error['Ciudad'])) ? "is-invalid" : ""; ?> value="<?php echo $txtCiudad; ?>" placeholder="" id="txtCiudad">
              ...
              <div class="form-group col-md-4">
                <label for=""><a href="https://www.sat.gob.mx/tramites/operacion/28753/obten-tu-rfc-con-la-clave-unica-de-registro-de-poblacion-curp" target="_blank" style="color: black;">RFC:</a></label>
                <input maxlength="35" title="Colocar su RFC con homoclave del SAT, si la desconoce puede consultarlo o tramitarlo al darle click en RFC: " required="required" type="text" name="txtRFC" class="form-control" <?php echo (isset($error['RFC'])) ? "is-invalid" : ""; ?> value="<?php echo $txtRFC; ?>" id="txtRFC">
              ...
              <div class="form-group col-md-6">
                ...
                <input title="Colocar el estado de la república en el que nació y colocar su fecha de nacimiento con el formato." required="required" type="text" name="txtLuYFeDNac" class="form-control" <?php echo (isset($error['LuYFeDNac'])) ? "is-invalid" : ""; ?> value="<?php echo $txtLuYFeDNac; ?>" placeholder="xxxxxx, dd/mm/aaaa" id="txtLuYFeDNac">
                <div class="invalid-feedback"><?php echo (isset($error['LuYFeDNac'])) ? $error['LuYFeDNac'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-3">
                <label for=""><a href="https://www.gob.mx/curp/" target="_blank" style="color: black;"> CURP:</a></label>
                <input minlength="18" maxlength="18" title="Favor de ingresar su CURP a 18 caracteres, si la desconoce puede dar click en CURP: para consultarla." required="required" type="text" name="txtCurp" class="form-control" <?php echo (isset($error['Curp'])) ? "is-invalid" : ""; ?> value="<?php echo $txtCurp; ?>" placeholder="" id="txtCurp">
              ...
              <div class="form-group col-md-4">
                ...
                <input required="required" type="email" name="txtEmail" class="form-control" <?php echo (isset($error['Email'])) ? "is-invalid" : ""; ?> value="<?php echo $txtEmail; ?>" placeholder="" id="txtEmail">
              ...
              <div class="form-group col-md-3">
                ...
                <input title="Escribir número de teléfono con clave lada a 10 digitos." required="required" type="text" name="txtTelefono" class="form-control" <?php echo (isset($error['Telefono'])) ? "is-invalid" : ""; ?> value="<?php echo $txtTelefono; ?>" placeholder="Ejemplo:  3312345678" id="txtTelefono">
              ...
              <div class="form-group col-md-2">
                <label for="">Nombre:</label>
                <input type="text" name="txtNombreD" class="form-control" <?php echo (isset($error['NombreD'])) ? "is-invalid" : ""; ?> value="<?php echo $txtNombreD; ?>" id="txtNombreD">
              ...
              <div class="form-group col-md-1">
                ...
                <input type="text" name="txtEdadD" class="form-control" <?php echo (isset($error['EdadD'])) ? "is-invalid" : ""; ?> value="<?php echo $txtEdadD; ?>" id="txtEdadD">
              ...
              <div class="form-group col-md-2">
                ...
                <input type="text" name="txtParentescoD" class="form-control" <?php echo (isset($error['ParentescoD'])) ? "is-invalid" : ""; ?> value="<?php echo $txtParentescoD; ?>" id="txtParentescoD">
              ...
              <div class="form-group col-md-2">
                <label for="">Ocupación:</label>
                <input type="text" name="txtOcupacionD" class="form-control" <?php echo (isset($error['OcupacionD'])) ? "is-invalid" : ""; ?> value="<?php echo $txtOcupacionD; ?>" placeholder="" id="txtOcupacionD">
              ...
              <div class="form-group col-md-5">
                ...
                <input type="text" name="txtDireccionD" class="form-control" <?php echo (isset($error['DireccionD'])) ? "is-invalid" : ""; ?> value="<?php echo $txtDireccionD; ?>" placeholder="" id="txtDireccionD">
              ...
              <div class="form-group col-md-2">
                <input type="text" name="txtNombreP" class="form-control" <?php echo (isset($error['NombreP'])) ? "is-invalid" : ""; ?> value="<?php echo $txtNombreP; ?>" id="txtNombreP">
                <div class="invalid-feedback"><?php echo (isset($error['NombreP'])) ? $error['NombreP'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-1">
                <input type="text" name="txtEdadP" class="form-control" <?php echo (isset($error['EdadP'])) ? "is-invalid" : ""; ?> value="<?php echo $txtEdadP; ?>" id="txtEdadP">
                <div class="invalid-feedback"><?php echo (isset($error['EdadP'])) ? $error['EdadP'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-2">
                <input type="text" name="txtParentescoP" class="form-control" <?php echo (isset($error['ParentescoP'])) ? "is-invalid" : ""; ?> value="<?php echo $txtParentescoP; ?>" id="txtParentescoP">
                <div class="invalid-feedback"><?php echo (isset($error['ParentescoP'])) ? $error['ParentescoP'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-2">
                <input type="text" name="txtOcupacionP" class="form-control" <?php echo (isset($error['OcupacionP'])) ? "is-invalid" : ""; ?> value="<?php echo $txtOcupacionP; ?>" id="txtOcupacionP">
                <div class="invalid-feedback"><?php echo (isset($error['OcupacionP'])) ? $error['OcupacionP'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-5">
                <input type="text" name="txtDireccionP" class="form-control" <?php echo (isset($error['DireccionP'])) ? "is-invalid" : ""; ?> value="<?php echo $txtDireccionP; ?>" id="txtDireccionP">
                <div class="invalid-feedback"><?php echo (isset($error['DireccionP'])) ? $error['DireccionP'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-2">
                <input type="text" name="txtNombreO" class="form-control" <?php echo (isset($error['NombreO'])) ? "is-invalid" : ""; ?> value="<?php echo $txtNombreO; ?>" id="txtNombreO">
                <div class="invalid-feedback"><?php echo (isset($error['NombreO'])) ? $error['NombreO'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-1">
                <input type="text" name="txtEdadO" class="form-control" <?php echo (isset($error['EdadO'])) ? "is-invalid" : ""; ?> value="<?php echo $txtEdadO; ?>" id="txtEdadO">
                <div class="invalid-feedback"><?php echo (isset($error['EdadO'])) ? $error['EdadO'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-2">
                <input type="text" name="txtParentescoO" class="form-control" <?php echo (isset($error['ParentescoO'])) ? "is-invalid" : ""; ?> value="<?php echo $txtParentescoO; ?>" id="txtParentescoO">
                <div class="invalid-feedback"><?php echo (isset($error['ParentescoO'])) ? $error['ParentescoO'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-2">
                <input type="text" name="txtOcupacionO" class="form-control" <?php echo (isset($error['OcupacionO'])) ? "is-invalid" : ""; ?> value="<?php echo $txtOcupacionO; ?>" id="txtOcupacionO">
                <div class="invalid-feedback"><?php echo (isset($error['OcupacionO'])) ? $error['OcupacionO'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-5">
                <input type="text" name="txtDireccionO" class="form-control" <?php echo (isset($error['DireccionO'])) ? "is-invalid" : ""; ?> value="<?php echo $txtDireccionO; ?>" id="txtDireccionO">
                <div class="invalid-feedback"><?php echo (isset($error['DireccionO'])) ? $error['DireccionO'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-2">
                <input type="text" name="txtNombreI" class="form-control" <?php echo (isset($error['NombreI'])) ? "is-invalid" : ""; ?> value="<?php echo $txtNombreI; ?>" id="txtNombreI">
                <div class="invalid-feedback"><?php echo (isset($error['NombreI'])) ? $error['NombreI'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-1">
                <input type="text" name="txtEdadI" class="form-control" <?php echo (isset($error['EdadI'])) ? "is-invalid" : ""; ?> value="<?php echo $txtEdadI; ?>" id="txtEdadI">
                <div class="invalid-feedback"><?php echo (isset($error['EdadI'])) ? $error['EdadI'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-2">
                <input type="text" name="txtParentescoI" class="form-control" <?php echo (isset($error['ParentescoI'])) ? "is-invalid" : ""; ?> value="<?php echo $txtParentescoI; ?>" id="txtParentescoI">
                <div class="invalid-feedback"><?php echo (isset($error['ParentescoI'])) ? $error['ParentescoI'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-2">
                <input type="text" name="txtOcupacionI" class="form-control" <?php echo (isset($error['OcupacionI'])) ? "is-invalid" : ""; ?> value="<?php echo $txtOcupacionI; ?>" id="txtOcupacionI">
                <div class="invalid-feedback"><?php echo (isset($error['OcupacionI'])) ? $error['OcupacionI'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-5">
                <input type="text" name="txtDireccionI" class="form-control" <?php echo (isset($error['DireccionI'])) ? "is-invalid" : ""; ?> value="<?php echo $txtDireccionI; ?>" id="txtDireccionI">
              ...
              <div class="form-group col-md-2">
                <input type="text" name="txtNombreM" class="form-control" <?php echo (isset($error['NombreM'])) ? "is-invalid" : ""; ?> value="<?php echo $txtNombreM; ?>" id="txtNombreM">
                <div class="invalid-feedback"><?php echo (isset($error['NombreM'])) ? $error['NombreM'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-1">
                <input type="text" name="txtEdadM" class="form-control" <?php echo (isset($error['EdadM'])) ? "is-invalid" : ""; ?> value="<?php echo $txtEdadM; ?>" id="txtEdadM">
                <div class="invalid-feedback"><?php echo (isset($error['EdadM'])) ? $error['EdadM'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-2">
                <input type="text" name="txtParentescoM" class="form-control" <?php echo (isset($error['ParentescoM'])) ? "is-invalid" : ""; ?> value="<?php echo $txtParentescoM; ?>" id="txtParentescoM">
                <div class="invalid-feedback"><?php echo (isset($error['ParentescoM'])) ? $error['ParentescoM'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-2">
                <input type="text" name="txtOcupacionM" class="form-control" <?php echo (isset($error['OcupacionM'])) ? "is-invalid" : ""; ?> value="<?php echo $txtOcupacionM; ?>" id="txtOcupacionM">
                <div class="invalid-feedback"><?php echo (isset($error['OcupacionM'])) ? $error['OcupacionM'] : ""; ?></div>
                <br>
              </div>

              <div class="form-group col-md-5">
                <input type="text" name="txtDireccionM" class="form-control" <?php echo (isset($error['DireccionM'])) ? "is-invalid" : ""; ?> value="<?php echo $txtDireccionM; ?>" id="txtDireccionM">
              ...
              <div class="col-md-2">
                <button value="btnAgregar"  data-toggle="modal" data-target="#myModal" <?php echo $accionAgregar; ?> class="btn btn-success" type="submit" name="accion">Agregar</buttton>
              </div>
        ...
        <div class="card mb-4">
          <div class="card-header">
            <i class="fas fa-table mr-1"></i>Registros existentes
          </div>
          <div class="card-body">
              ...
              <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                ...
                <tbody>
                  <?php foreach ($listEmpleados as $empleado) { ?>
                    <tr>
                      <td><img src="imagenes/<?php echo $empleado['Foto']; ?>" width="40px" height="40px" /></td>
                      ...
                      <td>
                        ...
                        <form action="reporteExcel.php" method="post">
                          <input type="hidden" name="txtID" value="">
                          <button class="btn btn-success ml-6" type="submit">
                            <i class="fas fa-file-excel"></i> </button>
                        </form>
                        <?php if ($tipo_usuario == 1) {  ?>
                          <button value="btnEliminar"   data-toggle="modal" data-target="#myModal" class="btn btn-danger" type="submit" name="accion">
