      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
          <?php if ($tipo_usuario == 1) { ?>
            <a class="dropdown-item" href="tabla.php">Configuracion</a>
          <?php } ?>
                      ...
                      <div class="row justify-content-center">
                        <div class="col-lg-6">
                          <div class="text-center mt-4">
                            <img src="img/logo.png" width="400" height="341">
                            <b>
                              <p class="lead">Bienvenido al Sistema Web de PROMASI</p>
                            </b>
                            <p>Profesionales en Mantenimiento y Servicios Industriales</p>
                          </div>
                        </div>
                      </div>
                    </div>
